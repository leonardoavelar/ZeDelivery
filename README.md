...
A API Ze Delivery foi criada utilizando a tecnologia C# em .Net Core 3.1 e MongoDB.
A aplicação gerencia o cadastro de parceiros da plataforma Ze Delivery.

A aplicação foi desenvolvida e estruturada com as seguintes camadas:
    * API
    * Application
...
Para executar a aplicação é essencia ter o MongoDB, e caso não tenha um servidor local, favor utilizar a imagem abaixo realizar o teste.
Para preparar o ambiente utilizando o Docker, bastar executar o comando abaixo para baixar a imagem e subir um container com MongoDB.
